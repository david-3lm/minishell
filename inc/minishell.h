...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/05 12:34:26 by cde-migu          #+#    #+#             */
/*   Updated: 2025/06/05 12:37:08 by cde-migu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			is_input_valid_unexpected_token(const char *input, \
			char *err_message);
...
int			has_spaces_between_char(const char *input, \
			char c, char *err_message);
int			has_forbidden_sequence(const char *input, \
			char *test, char *err_message);
int			has_non_supported(const char *input, char *test, char *err_message);
int			has_non_supported_one(const char *input, \
			char *test, char *err_message);
...
void		ft_change_env(t_cmd_table *table, char *key, \
			char *path, bool is_path);
...
void		set_redir(t_cmd *cmd, t_list *new_n, \
			const char *input, int *curr_pos);
...
void		ft_lstclear_if(t_list **lst, int (*cmp)(void *), \
			void (*del)(void *));
